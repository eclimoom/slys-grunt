...
/**
 * @ngdoc service
 * @name slysApp.services
 * @description
 * # services
 * Factory in the slysApp.
 */

angular.module('slysApp').factory("UserTest",["$resource","serverUrl",function($resource,serverUrl) {
  ...
  return $resource("/api/test", null,
    {
      ...
      getOrgById:{//获取机构详情
        method:"GET",
        url:"/3rd/getOrgById.json",
      },
      getUserByCard:{//获取用户详情
        method:"GET",
        url:"/3rd/getInfoByCardNum.json",
      },
...
*
* */
angular.module('slysApp').factory("Utils",[function() {
  var shareData = {};
  return {
...
angular.module('slysApp').factory("User",["$resource","serverUrl","cookieStore",function($resource,serverUrl,cookieStore) {
...
angular.module('slysApp').factory("Msg",["$resource","serverUrl",
...
angular.module('slysApp').factory("AuthService",function() {
  var currentUser ;
  return {
